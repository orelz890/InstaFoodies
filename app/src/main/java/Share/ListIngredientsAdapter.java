...
public class ListIngredientsAdapter extends ArrayAdapter<String> {
    ...
    public ListIngredientsAdapter(Context context, ArrayList<String> items, String key) {
        ...
        if (convertView == null) {
            ...
            remove.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (key.equals("add")) {
                        NextRecipeActivity.removeItem(position);
                    }else{
